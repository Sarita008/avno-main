    ...
    <>
      <div className='menu'>
        <div className='container'>
          ...
          <button className="btn">SIZE & FIT</button>
          <button className="btn">SHIPPING & RETURNS</button>
        </div>
      </div>
              {/* ------------PRODUCTS DETAILS------------- */}
         <div className='product-content-rx'>
            <div>
        ...
        <div className="carosel-container-rx">
            <div className="carosel-title-rx">
                <div className="sale-title-rx" style={{fontSize:"1.5em"}} >Customers Also Viewed</div>
            </div>
            <div>
                <Slider {...settings}>
                    {caroselImages.map((d) => (
                        <div key={Math.random()} className="carosel-items-rx">
                            <img src={d.img} alt="" />
                            <div className="carosel-description-rx">{d.discription}</div>
                            <div className="carosel-description-rx">{d.price}</div>
                            <button type="button" className="slick-prev-rx"></button>
                            <button type="button" className="slick-next-rx"></button>
                        </div>
                    ))}
        ...
        <div className="carosel-container-rx">
            <div className="carosel-title-rx">
                <div className="sale-title-rx" style={{fontSize:"1.5em"}} >Recommended Products</div>
            </div>
            <div>
                <Slider {...settings}>
                    {caroselImages.map((d) => (
